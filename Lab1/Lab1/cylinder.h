...
public:
	...
	Cylinder(glm::vec4 pos, const float height, const float radiusTop, const float radiusBottom, const glm::vec4& colorTop, const glm::vec4& colorBottom, int segments = 16) 
	{
	...
	void generateVertices(glm::vec4 pos, const float height, const float radiusTop, const float radiusBottom, const glm::vec4& colorTop, const glm::vec4& colorBottom, int segments = 16)
	{
